...
function ClassicTemplate({ cvData }) {
    ...
    return (
        <div className="p-10 font-serif max-w-full print:p-0" style={{ backgroundColor: '#ffffff', color: '#1F2937' }}>
            <header className="text-center mb-8">
                ...
                <div className="flex justify-center items-center gap-4 mt-2 text-sm" style={{ color: '#4B5563' }}>
                    {personalInfo?.phone && (
            ...
            <main className="space-y-6">
                {summary?.text && (
                    <section>
                        <h2 className="text-xl font-bold border-b pb-1 mb-2" style={{ borderColor: '#000000' }}>
                            Summary
                        </h2>
                        <p>{summary.text}</p>
                    </section>
